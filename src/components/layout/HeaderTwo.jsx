...
export default function HeaderTwo() {
  ...
  return (
    <>
      <header className="main-header main-header-one style2 clearfix">
              ...
              <div className="container">
                <div className="main-header-one__bottom-inner">
                  ...
                  <div className="main-header-one__bottom-right" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div className="main-header__cart-box" style={{ display: 'flex', alignItems: 'center', position: 'relative' }}>
                      <Link
                        to="/cart"
                        title="Shopping Cart"
