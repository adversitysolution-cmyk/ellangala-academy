  ...
  return (
    <>
      ...
      <div className="page-wrapper">
        <HeaderOne />
        <PageHeader title="Our Services & Programs" breadcrumb="Services" />

        {/* Section 1: POSITIVE WORKSHOPS */}
        <section className="services-one" style={{ paddingBottom: '70px' }}>
          <div className="container">
            ...
            <div className="section-title text-center" style={{ marginBottom: '50px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '13.5px', fontWeight: 700, color: '#CA8A38', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '8px' }}>
                <i className="fa fa-spa" style={{ fontSize: '12px' }}></i> EXPLORE OUR OFFERINGS
              </div>
        ...
        {/* Section 2: POSITIVE MENTORING */}
        <section className="services-one" style={{ paddingTop: '50px', paddingBottom: '70px', backgroundColor: '#FAF8F5', borderTop: '1px solid #ECE3D6' }}>
          <div className="container">
            {/* Section Header */}
            <div className="section-title text-center" style={{ marginBottom: '50px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '13.5px', fontWeight: 700, color: '#CA8A38', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '8px' }}>
        ...
        {/* Section 3: Our Best Recomended Programs */}
        <section className="services-one" style={{ paddingTop: '60px', paddingBottom: '90px', backgroundColor: '#FFFFFF', borderTop: '1px solid #ECE3D6' }}>
          <div className="container">
            {/* Section Header */}
            <div className="section-title text-center" style={{ marginBottom: '50px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '13.5px', fontWeight: 700, color: '#CA8A38', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '8px' }}>
